...
from test_MAMS import evaluate_val_accuracy
...
class ClassificationModel:
    ...
    def train(
        ...
        **kwargs,
        ...
        accuracy = evaluate_val_accuracy(self,"./asap_data/val.txt")
        ...
        for _ in train_iterator:
            ...
            if accuracy > best_accuracy:
                ...
                print('---test dataset----')
                test_acc = evaluate_val_accuracy(self,"./asap_data/test.txt")
                with open('./asap_bert_best_accuracy.txt', 'a') as f0:
