...
class Seq2SeqModel:
    ...
    def train(
        ...
        for current_epoch in train_iterator:
            ...
            accuracy = predict_val(model, self.device, self.encoder_tokenizer)
            ...
            # if True:
                ...
                print('---test dataset----')
                test_acc = predict_test(model, self.device, self.encoder_tokenizer)
                with open(f'./asap_{self.args.model_type}_best_accuracy.txt', 'a+') as f0:
