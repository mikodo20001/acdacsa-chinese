...
from test_MAMS import evaluate_val_accuracy_acd
    ...
    def train(
        ...
        **kwargs,
        ...
        for _ in train_iterator:
            ...
            epoch_number += 1
            accuracy = evaluate_val_accuracy_acd(self,"./asap_acd_data/val.txt")
            if accuracy > best_accuracy:
                ...
                print('---test dataset----')
                test_acc = evaluate_val_accuracy_acd(self,"./asap_acd_data/test.txt")
                with open('./asap_acd_bert_best_accuracy.txt', 'a') as f0:
